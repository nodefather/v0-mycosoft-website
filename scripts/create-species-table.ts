    ...
    if (Number.parseInt(existingCount[0].count) === 0) {
      ...
      const mushroomSpecies = [
        ...
        },
        {
          ...
          description:
            "Popular culinary mushroom with umbrella-shaped brown caps and cream gills, native to East Asia.",
        ...
        },
        {
          ...
          description:
            'Bright orange to yellow shelf-like brackets growing on trees. Has a texture similar "Bright orange to yellow shelf-like brackets growing on trees. Has a texture similar to chicken when cooked, hence the name.',
          image_url: "/vibrant-chicken-of-the-woods.png",
          characteristics: ["Edible", "Culinary"],
        },
      ]
